...
import org.zetool.components.ComponentLocalization;

/**
 * Creates a complete framework to create menus inclusive shortcuts and
 * {@link java.awt.event.ActionListener}. Currently only works with
 * CTRL-shortcuts
 *
...
public class Menu {
     ...
     */
    private static Localization loc = ComponentLocalization.LOC;
    ...
    /**
     * Sets a {@code AbstractLocalization} object that is used to generate
     * localized menu entries.
     *
     * @param loc the {@code AbstractLocalization} opbject.
     */
     ...
     * @param localizedString the localization string for the menu title, if "-"
     * separator
     ...
     *
     * @param m the JLocalizedMenu
     * @param localizedString the menu title
     * @param keyChar the shortcut character
     * @param al an ActionListener
     * @param commandString an action command
     * @return a JLocalizedMenuItem
